...
- you need to download the saved_models.zip file located in the "inference_notebook" folder and then paste it into the files in the inference notebook. keep it zipped
